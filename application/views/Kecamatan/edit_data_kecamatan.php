...
<br>
   <div class="breadcomb-area">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <p>Edit Data Kecamatan<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
     ...
     <?php echo form_open_multipart('ListKecamatan/update/'.$this->uri->segment(3)); 
        ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_kecamatan" name="nama_kecamatan" placeholder="Nama Kecamatan" value="<?php echo $kecamatan[0]->nama_kecamatan?>">
                                    </div>
                                </div>
                            </div>
                     <br>
                    ...
                    <a href="<?php echo base_url('index.php/ListKecamatan')?>"class="btn btn-danger">Back <span class="glyphicon glyphicon-arrow-left"></a></td>
                    </center>
