...
<body>
   ...
   <div class="breadcomb-area">
    ...
    <?php echo form_open_multipart('ListLaporan/create'); 
        ...
        echo validation_errors();
                ...
                <div class="form-group">
                    <input type="hidden" class="form-control" id="id_laporan" name="id_laporan" value="<?php echo $id ?>">
                </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                         <!--    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="id_user" name="id_user" placeholder="Nama Lengkap">
                                    </div>
                                </div>
                            </div> -->
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="tanggal" name="tanggal" placeholder="Tanggal Kegiatan(DD-MM-YYYY)">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="uraian_tempat" name="uraian_tempat" placeholder="Uraian Tempat">
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="pelaksana" name="pelaksana" placeholder="Pelaksana">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <div class="basic-tb-hd">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="faktor_pendukung_penghambat" name="faktor_pendukung_penghambat" placeholder="Faktor Pendukung & Penghambat">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="upaya_pemecahan" name="upaya_pemecahan" placeholder="Upaya Pemecahan Masalah">
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="rencana_kerja" name="rencana_kerja" placeholder="Rencana Kerja">
                                    </div>
                                </div>
                            </div>
                         </div>
